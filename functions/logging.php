...
/*функция записывает в таблицу logs_action следующие события: создание пользователя, редактирование прав (не реализовано),
удаление пользователя (не реализовано), очиска старых логов, импорт .cvs в БД, генерация сети*/
